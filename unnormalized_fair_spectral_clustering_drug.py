...
def ufsc(dataset, num_clusters, dataset_config_file, max_points, eta):
    ...
    f1_balance, sum_balance1 = meas.balance(f1_labels, df_or, attributes, representation, fairness_variable, num_clusters)
    f2_balance, sum_balance2 = meas.balance(f2_labels, df_or, attributes, representation, fairness_variable, num_clusters)
    uf_balance, sum_balance = meas.balance(uf_labels, df_or, attributes, representation, fairness_variable, num_clusters)

    res1 = Res(f1_ed, f1_sh, sum_balance1, f1_ratio_cut)
    res2 = Res(f2_ed, f2_sh, sum_balance2, f2_ratio_cut)
    res0 = Res(uf_ed, uf_sh, sum_balance, uf_ratio_cut)
    ...
    result = judge(res1, res2, res0)

    return res0, result, res1
